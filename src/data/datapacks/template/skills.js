...
export const skills = [
    {
        ...
        tags: ["featured", "domain", "personal", "company1"], // can reference the category and associations and have a "featured" and/or "personal" tag
        description: [
    ...
    },
    {
        ...
        icon: FaServer, // can be a React component
        tags: ["featured", "language", "company1"],
        description: [
            "Some string.",
    ...
    {
        id: "skill3",
        title: "Some other other skill",
        icon: FaServer,
        tags: ["framework", "personal", "school1"],
        description: [
            "Some string.",
            "Another string with <b>HTML tags</b>.",
            <>Some React element.</>
    ...
    {
        id: "skill4",
        title: "Some other other other skill",
        icon: FaServer,
        tags: ["tool", "school1"],
        description: [
            "Some string.",
