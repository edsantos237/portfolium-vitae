...
export const about = {
    full_name: "Full Name",
    birthdate: "2000-01-01", // ISO date string (YYYY-MM-DD), will be used to calculate age
    location: "Location",
    description: [  // written under "Who am I?"
    ...
    drivers_license: ["B", "B1"] // driver's license categories
};